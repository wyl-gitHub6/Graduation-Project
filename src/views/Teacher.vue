<template>
  <div class="common-layout">
    <el-container>
      <el-main>
        <el-button type="success" icon="el-icon-plus" @click="model = true,title='录入教师信息',btn=true" style="margin-left: 100px;">录入信息</el-button>
          ...
          <el-dialog :title="title" v-model="model" width="30%" center>
            <el-form :label-position="labelPosition" label-width="80px" :model="teacher_form"
              ...
              <el-form-item label="年龄" prop="teacherAge">
                <el-input v-model="teacher_form.teacherAge"></el-input>
              </el-form-item>
